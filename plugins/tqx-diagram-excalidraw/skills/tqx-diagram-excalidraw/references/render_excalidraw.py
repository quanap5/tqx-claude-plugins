...
Run from this skill's own references/ directory (the folder containing this file).
...
def render(
    ...
    try:
        ...
        print("Run from this skill's references/ dir: uv sync && uv run playwright install chromium", file=sys.stderr)
        sys.exit(1)
    ...
    with sync_playwright() as p:
        try:
            ...
            if "Executable doesn't exist" in str(e) or "browserType.launch" in str(e):
                ...
                print("Run from this skill's references/ dir: uv run playwright install chromium", file=sys.stderr)
                sys.exit(1)
            raise
